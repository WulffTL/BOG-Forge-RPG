...
public class StaticShader extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = "./Plymordior2/src/shaders/vertexShader";
    private static final String FRAGMENT_FILE = "./Plymordior2/src/shaders/fragmentShader";
